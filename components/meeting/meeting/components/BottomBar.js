...
import recordingBlink from "@/components/static/animations/recording-blink.json";
    ...
    return (
      <div className="flex items-center justify-center lg:ml-0 ml-4 mt-4 xl:mt-0">
        <div className="flex border-2 border-gray-850 p-2 rounded-md items-center justify-center">
          ...
          >
            {isCopied ? (
              <i className="h-5 w-5 text-green-400">green</i>
            ) : (
              <i className="h-5 w-5 text-white">white</i>
            )}
          </button>
        </div>
      </div>
